...
export default function SideBar() {
  return (
    <div className="flex min-h-screen">
      <aside className="w-60 bg-green-4 text-white flex flex-col p-4">
        <div className="mb-4 flex items-center space-x-2">
          <div className="w-8 h-8 bg-green-1 rounded-lg flex items-center justify-center">
            <Image className="rounded-lg" src="/BayLeaf.png" alt="B" width={30} height={30} />
          </div>
          <h2 className="text-2xl font-bold text-green-1">LegalBay</h2>
        </div>
        <nav>
          <ul>
